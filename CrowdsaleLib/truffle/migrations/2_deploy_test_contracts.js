...
module.exports = function(deployer, network, accounts) {
  ...
  if(network == "development"){
    ...
    deployer.deploy(CrowdsaleToken, accounts[5], "Tester Token", "TST", 18, 1000000000000000000000000, true,{from:accounts[5]}).then(function() {
      ...
      //return deployer.deploy(DirectCrowdsaleTestContract, "0x36994c7cff11859ba8b9715120a68aa9499329ee", 20000000000000000000000, 1505203200, 1505462400, [50,75,100], 86400, CrowdsaleToken.address);
 	    return deployer.deploy(TimeDirectCrowdsaleTestContract, accounts[5], 100, 1700000000, 105, 125, [50,75,100], 29000, 5, CrowdsaleToken.address,{from:accounts[5]});
    });
  }
